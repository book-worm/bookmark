...
module.exports = function(profile, callback) {
  ...
  return request('https://www.goodreads.com/user/show.xml?id='+goodreadsId+'&key=Xm4nm2BGBj7neBeBIIjqeQ', function (error, response, body) {
...
var assignCurrentBooks = function(user, callback) {
  return request('https://www.goodreads.com/review/list/'+user.goodreadsId+'?format=xml&key=Xm4nm2BGBj7neBeBIIjqeQ&v=2&shelf=currently-reading', function (error, response, body) {
    parseString(body, function (err, result) {
